...
#define Nk	4	//	Number of 32-bt words comprising the Cipher Key.
#define Nr	10	//	Number of rounds, which is a function of Nk and Nb. Nr = Nb + Nk + 2.
